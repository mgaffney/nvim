...
require("lazy").setup({
  ...
  "github/copilot.vim",
  {
    ...
    keys = {
      ...
      { "<leader>a,", "ga*,", mode = "x", remap = true, silent = true, desc = "Align selection on comma" },
      { "<leader>a<space>", "vapga*<space>", remap = true, silent = true, desc = "Align paragraph on space" },
      { "<leader>a<space>", "ga*<space>", mode = "x", remap = true, silent = true, desc = "Align selection on space" },
    },
  },
  "mbbill/undotree",
  {
...
if exists('$TMUX')
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Disable built-in autocomplete in Telescope prompt buffers
